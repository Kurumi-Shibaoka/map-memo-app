...
職業訓練校の卒業制作として、Java / Servlet / MySQL を使ったMVC構成のWebアプリを一人で開発しました。
画面設計・DB設計・実装などひとりで担当。AIツールを補助として活用しながら、
「自分で考えた上でAIを使う」開発スタイルを意識して取り組みました。

## 📖 概要・目的

「今日なに食べる？」「この辺でいいお店ある？」そんな場面でサッと答えられるよう、
行ったお店や気になるお店を記録しておけるアプリを目指して開発しました。

Googleマップと連携することで、登録したお店の場所を地図で確認したり、ナビや口コミへのアクセスも簡単に行えます。

なお、デザインのアイデアや画面構成は自分で考え、コードの実装・コメント整備の場面でAIアシスタントをツールとして活用しました。
